...
VTSkip:
    ...
    ''' 1. Remove Closeup and Sideview<br></br>
    ''' 2. Change: Naked -> GarmentCovering <br></br>
    ''' 3. Change: GarmentCovering -> HalfDressed <br></br>
    ''' 4. Change: HalfDressed -> FullDressed <br></br>
    ''' 5. Change: HandsCovering -> GarmentCovering <br></br>
    ''' 6. Remove: Excluded Tags from the BaseTags <br></br>
    ''' 7-10 same as 1-5 without Excluded tags. If there are none this will be skipped.<br></br>
    ''' 11. Change: FullDressed -> HalfDressed <br></br>
    ''' 12. Change: HalfDressed -> Naked <br></br>
...
retry_NextStage:
                        If ___mc.Count <= 0 AndAlso ___retryStage <= 12 Then
                            '▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
...
FileNotFound_GetNext:
	...
	Public Function FilterList(ByVal ListClean As List(Of String)) As List(Of String)
        ...
        ' Check if DommeImageStr is set, otherwise the image won't show up sometimes...
        If DommeImageSTR = "" Then DommeImageFound = False
